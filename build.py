...
<p>© 2026 ClearGridStudios · Spreadsheets &amp; templates with formulas that provably work.</p>
...
PAGES["index"] = (
    "ClearGridStudios — Spreadsheets & Templates That Provably Work",
    ...
    f"""
<div class="hero">
<h1>Spreadsheets with formulas that <em>provably</em> work</h1>
